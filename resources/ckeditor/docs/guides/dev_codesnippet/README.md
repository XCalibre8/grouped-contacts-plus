...
For a complete list of available themes see the [Inserting Code Snippets sample](../samples/codesnippet.html) or the [highlight.js's demo page](http://highlightjs.org/static/test.html).
